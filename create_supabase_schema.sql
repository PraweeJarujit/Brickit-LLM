-- BRICKIT Database Schema for Supabase
-- Run this in Supabase SQL Editor

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Users table (for local sync)
...
-- Insert sample data (only use existing columns)
INSERT INTO users (username, email) VALUES 
('test', 'test@gmail.com'),
('Mickey', 'Mickey@gmail.com')
ON CONFLICT (email) DO NOTHING;

INSERT INTO products (name, price, size_category, stock_count) VALUES 
('Modern Office Chair', 299.99, 'M', 10),
('Standing Desk', 599.99, 'L', 5),
('Drawer Organizer', 49.99, 'S', 20)
